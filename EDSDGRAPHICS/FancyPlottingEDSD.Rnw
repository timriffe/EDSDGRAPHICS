...
\SweaveInput{compare/compare}
\SweaveInput{color/color}
\SweaveInput{color/colorexample}
\SweaveInput{surfaces/surfaces}
\SweaveInput{surfaces/image}
\SweaveInput{surfaces/image.plot}
\SweaveInput{surfaces/levelplot}
\SweaveInput{surfaces/geomtile} 
\SweaveInput{surfaces/PlotLexisTriangles}
\end{document}
