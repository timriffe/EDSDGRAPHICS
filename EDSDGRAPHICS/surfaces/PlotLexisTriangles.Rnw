...
<<lextri>>=
#install.packages("data/LexisSurface_1.1.zip",repos=NULL)
...
# plot it: dimensions and legend took some experimentation
#windows(height=7,width=7)
#x11(height=7,width=7) on *nix 
#Quartz(height=7,width=7) on mac

par(mar=c(6,2,5,2))
PlotLexisTriangles(UpperTriangles,LowerTriangles,colorramp=myFxcols,log=FALSE,
		lex.line.int=5,main="APC Fertility Rates, NE, 1950-2009, HFD",
		leg.coords=c(1960,3,1999,5))
@
